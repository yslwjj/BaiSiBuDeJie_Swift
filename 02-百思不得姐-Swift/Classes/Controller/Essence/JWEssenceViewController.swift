...
class JWEssenceViewController: UIViewController {
    ...
    func leftButtonTapped(button: UIButton) {
        navigationController?.pushViewController(UIStoryboard.essenceController(), animated: true)
    }
}
